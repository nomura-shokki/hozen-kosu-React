...
urlpatterns = [
  ...
  path('def_update/<int:pk>/', def_views.def_update, name='def_update'),
  path('def_delete/<int:pk>/', def_views.def_delete, name='def_delete'),
  ...
  path('input', kosu_views.KosuInputView.as_view(), name='input'), # 工数入力画面
  ...
  path('detail/<int:num>', kosu_views.DetailView.as_view(), name='detail'), # 工数編集画面
  ...
  path('over_time', kosu_views.OverTimeView.as_view(), name='over_time'), # 個人残業管理画面
  path('schedule', kosu_views.ScheduleView.as_view(), name='schedule'), # 勤務入力画面
  ...
  path('kosu_Ver', def_views.KosuVer.as_view(), name='kosu_Ver'), # 工数区分定義Ver切替画面
  ...
  path('def_edit/<int:pk>', def_views.DefEditView.as_view(), name='def_edit'), # 工数区分定義編集画面
