...
urlpatterns = [
  ...
  path('start_kosu_load', lambda request: asynchronous_views.start_task(request, 'kosu_load'), name='start_kosu_load'),
  ...
  path('check_kosu_load_status', asynchronous_views.check_task_status, name='check_kosu_load_status'),
