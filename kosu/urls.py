...
urlpatterns = [
  ...
  path('start_member_load', lambda request: asynchronous_views.start_task(request, 'member_load'), name='start_member_load'),
  ...
  path('check_member_load_status', asynchronous_views.check_task_status, name='check_member_load_status'), 
