...
class input_kosuForm(forms.Form):
  ...
  work_detail = forms.CharField(label = '作業詳細', required = False, widget = forms.TextInput(attrs = {'class' : 'form-control custom-border', 'placeholder' : '未入力可 メモで使用', 'style' : 'width : 150px;'}))
